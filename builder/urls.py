...
urlpatterns = [
    ...
    path("question/<int:question_id>/section/", views.question_assign_section, name="question_assign_section"),
    ...
    path("form/<int:form_id>/default-section-title/", views.update_default_section_title, name="update_default_section_title"),
]
