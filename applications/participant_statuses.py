...
PARTICIPANT_STATUS_SHEET_LABELS = dict(
    zip(PARTICIPANT_STATUS_CODES, PARTICIPANT_STATUS_SHEET_OPTIONS)
)
...
PARTICIPANT_STATUS_GRADUATION_ELIGIBLE = (
    PARTICIPANT_STATUS_GRADUATED | PARTICIPANT_STATUS_DROPPED_OUT
)
